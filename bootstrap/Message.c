...
extern void Message_AstError(o7_int_t code) {
	...
	case -30:
		...
		break;
	case -31:
		C(30, (o7_char *)"Expected assignable designator");
		break;
	case -111:
		C(43, (o7_char *)"Assign string to array with not enough size");
		break;
	case -32:
	...
	case -80:
		...
		break;
	case -81:
		C(40, (o7_char *)"Division by negative number is undefined");
		break;
	case -82:
	...
	case -98:
		...
		break;
	case -99:
		C(71, (o7_char *)"Declared variable which type is pointer to incompletely declared record");
		break;
	case -100:
		C(56, (o7_char *)"Incompletely declared record is used as subtype of array");
		break;
	case -101:
		C(67, (o7_char *)"Pointer to incompletely declared record is used as subtype of array");
		break;
	case -103:
...
extern void Message_Usage(o7_bool full) {
	S(57, (o7_char *)"Translator from Oberon-07 to C. 2019");
	S(7, (o7_char *)"Usage: ");
	S(12, (o7_char *)" 1) o7c help");
	S(59, (o7_char *)" 2) o7c to-c     Code OutDir { -m PM | -i PI | -infr Infr }");
	S(75, (o7_char *)" 3) o7c to-bin   Code OutBin {-m PM|-i PI|-infr I|-c PHC|-cc CComp|-t Temp}");
	S(70, (o7_char *)" 4) o7c run      Code {-m PM|-i PI|-c PHC|-cc CComp|-t Temp} [-- Args]");
	if (full) {
		S(0, (o7_char *)"");
		S(45, (o7_char *)"2) to-c     converts modules to .h & .c files");
		S(68, (o7_char *)"3) to-bin   converts modules to executable through implicit .c files");
		S(45, (o7_char *)"4) run      executes implicit executable file");
		S(0, (o7_char *)"");
		S(63, (o7_char *)"Code is simple Oberon-source. Can be described in kind of EBNF:");
		S(78, (o7_char *)"  Code = Call { ; Call } . Call = Module [ .Procedure [ '('Parameters')' ] ] .");
		S(54, (o7_char *)"OutDir - directory for saving translated .h & .c files");
		S(39, (o7_char *)"OutBin - name of output executable file");
		S(0, (o7_char *)"");
		S(50, (o7_char *)"-m PM - Path to directory with Modules for search.");
		S(50, (o7_char *)"  For example: -m library -m source -m test/source");
		S(76, (o7_char *)"-i PI - Path to directory with Interface modules without real implementation");
		S(40, (o7_char *)"  For example: -i singularity/definition");
		S(77, (o7_char *)"-c PHC - Path to directory with .h & .c -implementations of interface modules");
		...
		S(0, (o7_char *)"");
		S(22, (o7_char *)"Generator's arguments:");
		S(71, (o7_char *)"-init ( noinit | undef | zero )  - kind of variables auto-initializing.");
		S(35, (o7_char *)"  noinit -  without initialization.");
		S(50, (o7_char *)"  undef* -  special values for error's diagnostic.");
		S(27, (o7_char *)"  zero   -  fill by zeroes.");
		S(69, (o7_char *)"-memng ( nofree | counter | gc ) - kind of dynamic memory management.");
		S(30, (o7_char *)"  nofree*  -  without release.");
		S(78, (o7_char *)"  counter  -  automatic reference counting without automatic loops destroying.");
		S(64, (o7_char *)"  gc       -  garbage collection by Boehm-Demers-Weiser library.");
		S(79, (o7_char *)"-no-array-index-check         - turn off runtime check that index within range.");
		S(70, (o7_char *)"-no-nil-check                 - turn off runtime check pointer on nil.");
		S(75, (o7_char *)"-no-arithmetic-overflow-check - turn off runtime check arithmetic overflow.");
		S(0, (o7_char *)"");
		S(64, (o7_char *)"-C90 | -C99 | -C11            - ISO standard of generated C-code");
	}
}
...
extern void Message_CliError(o7_int_t err) {
	...
	case -15:
		...
		break;
	case -16:
		S(15, (o7_char *)"Unknown command");
		Message_Usage((0 > 1));
		break;
	case -17:
		S(41, (o7_char *)"Not enough count of arguments for command");
		break;
	case -18:
	...
	case -26:
		...
		break;
	case -27:
		S(33, (o7_char *)"Unknown kind of memory management");
		break;
	case -28:
