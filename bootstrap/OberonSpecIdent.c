...
static o7_bool Eq(o7_int_t str_len0, o7_char str[/*len0*/], o7_int_t buf_len0, o7_char buf[/*len0*/], o7_int_t ind, o7_int_t end) {
	...
	O7_ASSERT(buf[o7_ind(buf_len0, ind)] == str[0]);
...
extern o7_bool OberonSpecIdent_IsModule(o7_int_t buf_len0, o7_char buf[/*len0*/], o7_int_t ind, o7_int_t end) {
	...
	match = (o7_char)'M' == buf[o7_ind(buf_len0, ind)];
	if (match) {
		save = buf[o7_ind(buf_len0, end)];
		buf[o7_ind(buf_len0, end)] = 0x08u;
		match = Eq(7, (o7_char *)"MODULE", buf_len0, buf, ind, end);
...
extern o7_bool OberonSpecIdent_IsKeyWord(o7_int_t *kw, o7_int_t buf_len0, o7_char buf[/*len0*/], o7_int_t ind, o7_int_t end) {
	...
	{ o7_int_t o7_case_expr = buf[o7_ind(buf_len0, ind)];
		...
		case 68:
			...
			break;
		case 69:
			spec = O(kw, 5, (o7_char *)"ELSE", OberonSpecIdent_Else_cnst, buf_len0, buf, ind, end) || T(kw, 6, (o7_char *)"ELSIF", OberonSpecIdent_Elsif_cnst, 4, (o7_char *)"END", OberonSpecIdent_End_cnst, buf_len0, buf, ind, end);
			break;
		case 70:
			spec = T(kw, 6, (o7_char *)"FALSE", OberonSpecIdent_False_cnst, 4, (o7_char *)"FOR", OberonSpecIdent_For_cnst, buf_len0, buf, ind, end);
			break;
		case 73:
			spec = T(kw, 3, (o7_char *)"IF", OberonSpecIdent_If_cnst, 7, (o7_char *)"IMPORT", OberonSpecIdent_Import_cnst, buf_len0, buf, ind, end) || T(kw, 3, (o7_char *)"IN", OberonSpecIdent_In_cnst, 3, (o7_char *)"IS", OberonSpecIdent_Is_cnst, buf_len0, buf, ind, end);
			break;
		case 77:
		...
		case 80:
			...
			break;
		case 82:
			spec = O(kw, 7, (o7_char *)"RECORD", OberonSpecIdent_Record_cnst, buf_len0, buf, ind, end) || T(kw, 7, (o7_char *)"REPEAT", OberonSpecIdent_Repeat_cnst, 7, (o7_char *)"RETURN", OberonSpecIdent_Return_cnst, buf_len0, buf, ind, end);
			break;
		case 84:
			spec = T(kw, 5, (o7_char *)"THEN", OberonSpecIdent_Then_cnst, 3, (o7_char *)"TO", OberonSpecIdent_To_cnst, buf_len0, buf, ind, end) || T(kw, 5, (o7_char *)"TRUE", OberonSpecIdent_True_cnst, 5, (o7_char *)"TYPE", OberonSpecIdent_Type_cnst, buf_len0, buf, ind, end);
			break;
		case 85:
...
extern o7_bool OberonSpecIdent_IsPredefined(o7_int_t *pd, o7_int_t buf_len0, o7_char buf[/*len0*/], o7_int_t begin, o7_int_t end) {
	...
	{ o7_int_t o7_case_expr = buf[o7_ind(buf_len0, begin)];
		switch (o7_case_expr) {
		case 65:
			spec = O(pd, 4, (o7_char *)"ABS", OberonSpecIdent_Abs_cnst, buf_len0, buf, begin, end) || T(pd, 4, (o7_char *)"ASR", OberonSpecIdent_Asr_cnst, 7, (o7_char *)"ASSERT", OberonSpecIdent_Assert_cnst, buf_len0, buf, begin, end);
			break;
		case 66:
		...
		case 70:
			...
			break;
		case 73:
			spec = O(pd, 4, (o7_char *)"INC", OberonSpecIdent_Inc_cnst, buf_len0, buf, begin, end) || T(pd, 5, (o7_char *)"INCL", OberonSpecIdent_Incl_cnst, 8, (o7_char *)"INTEGER", OberonSpecIdent_Integer_cnst, buf_len0, buf, begin, end);
			break;
		case 76:
