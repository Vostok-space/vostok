...
extern o7_bool SpecIdentChecker_IsCKeyWord(struct StringStore_String *n) {
	...
	{ o7_int_t o7_case_expr = O7_REF((*n).block)->s[o7_ind(StringStore_BlockSize_cnst + 1, (*n).ofs)];
		switch (o7_case_expr) {
		case 97:
...
extern o7_bool SpecIdentChecker_IsSpecModuleName(struct StringStore_String *n) {
	return Eq(&(*n), 3, (o7_char *)"O7") || Eq(&(*n), 3, (o7_char *)"o7") || Eq(&(*n), 5, (o7_char *)"math") || Eq(&(*n), 7, (o7_char *)"limits") || Eq(&(*n), 3, (o7_char *)"ru");
}

extern o7_bool SpecIdentChecker_IsO7SpecName(struct StringStore_String *name) {
	return Eq(&(*name), 5, (o7_char *)"init") || Eq(&(*name), 5, (o7_char *)"cnst") || Eq(&(*name), 4, (o7_char *)"len") || Eq(&(*name), 5, (o7_char *)"proc") || Eq(&(*name), 5, (o7_char *)"cyrl");
}
