...
extern o7_bool SpecIdentChecker_IsJavaLib(struct StringStore_String *n) {
	...
	{ o7_int_t o7_case_expr = O7_REF((*n).block)->s[o7_ind(StringStore_BlockSize_cnst + 1, (*n).ofs)];
		switch (o7_case_expr) {
		case 67:
			o = Eq(&(*n), 5, (o7_char *)"Class");
			break;
		case 77:
			o = Eq(&(*n), 4, (o7_char *)"Math");
			break;
		case 83:
			o = Eq(&(*n), 6, (o7_char *)"String");
			break;
		default:
...
extern o7_bool SpecIdentChecker_IsSpecModuleName(struct StringStore_String *n) {
	return Eq(&(*n), 2, (o7_char *)"O7") || Eq(&(*n), 2, (o7_char *)"o7") || Eq(&(*n), 4, (o7_char *)"math") || Eq(&(*n), 6, (o7_char *)"limits") || Eq(&(*n), 2, (o7_char *)"ru");
}
