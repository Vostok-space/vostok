...
typedef struct Ast_RModule *(*Ast_Provide)(struct Ast_RProvider *p, struct Ast_RModule *host, int name_len0, o7c_char name[/*len0*/], int ofs, int end);
...
extern o7c_tag_t Ast_RProcType_tag;
