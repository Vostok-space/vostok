...
static void Import(struct GeneratorC_Generator *gen, o7c_tag_t gen_tag, struct Ast_RDeclaration *decl) {
	TextGenerator_Str(&(*gen)._, gen_tag, "#include ", 10);
	TextGenerator_Str(&(*gen)._, gen_tag, "\x22", 2);
	TextGenerator_String(&(*gen)._, gen_tag, &decl->module->_._.name, StringStore_String_tag);
	TextGenerator_Str(&(*gen)._, gen_tag, ".h", 3);
	TextGenerator_StrLn(&(*gen)._, gen_tag, "\x22", 2);
}
...
static void Factor(struct GeneratorC_Generator *gen, o7c_tag_t gen_tag, struct Ast_RExpression *expr) {
	if (o7c_is(expr, Ast_RFactor_tag)) {
		...
		TextGenerator_Str(&(*gen)._, gen_tag, "(", 2);
		expression(&(*gen), gen_tag, expr);
		TextGenerator_Str(&(*gen)._, gen_tag, ")", 2);
	}
}
...
static void ArrayDeclLen(struct GeneratorC_Generator *gen, o7c_tag_t gen_tag, struct Ast_RType *type, struct Ast_RDeclaration *decl, struct Ast_RSelector *sel) {
	...
	if (O7C_GUARD(Ast_RArray, &type)->count != NULL) {
		...
		TextGenerator_Str(&(*gen)._, gen_tag, "_len", 5);
		i =  - 1;
		while (sel != NULL) {
			i = o7c_add(i, 1);
			sel = sel->next;
...
static void Selector_Record(struct GeneratorC_Generator *gen, o7c_tag_t gen_tag, struct Ast_RType **type, struct Ast_RSelector **sel) {
	...
	if (o7c_cmp((*type)->_._.id, Ast_IdPointer_cnst) ==  0) {
		TextGenerator_Str(&(*gen)._, gen_tag, "->", 3);
	} else {
		TextGenerator_Str(&(*gen)._, gen_tag, ".", 2);
	}
	if (!(*gen).opt->plan9) {
		while ((up != NULL) && !Record_Selector_Search(up, var_)) {
			up = up->base;
			TextGenerator_Str(&(*gen)._, gen_tag, "_.", 3);
		}
	}
...
static void Array_Selector_Mult(struct GeneratorC_Generator *gen, o7c_tag_t gen_tag, struct Ast_RDeclaration *decl, int j, struct Ast_RType *t) {
	while ((t != NULL) && (o7c_is(t, Ast_RArray_tag))) {
		TextGenerator_Str(&(*gen)._, gen_tag, " * ", 4);
		Name(&(*gen), gen_tag, decl);
		TextGenerator_Str(&(*gen)._, gen_tag, "_len", 5);
...
static void Selector_Array(struct GeneratorC_Generator *gen, o7c_tag_t gen_tag, struct Ast_RType **type, struct Ast_RSelector **sel, struct Ast_RDeclaration *decl, o7c_bool isDesignatorArray) {
	...
	if ((o7c_cmp((*type)->_.type->_._.id, Ast_IdArray_cnst) !=  0) || (O7C_GUARD(Ast_RArray, &(*type))->count != NULL)) {
		if (o7c_bl((*gen).opt->checkIndex) && ((O7C_GUARD(Ast_SelArray_s, &(*sel))->index->value_ == NULL) || (O7C_GUARD(Ast_RArray, &(*type))->count == NULL) && (o7c_cmp(O7C_GUARD(Ast_RExprInteger, &O7C_GUARD(Ast_SelArray_s, &(*sel))->index->value_)->int_, 0) !=  0))) {
			TextGenerator_Str(&(*gen)._, gen_tag, "o7c_ind(", 9);
		...
		while (((*sel) != NULL) && (o7c_is((*sel), Ast_SelArray_s_tag))) {
			if (o7c_bl((*gen).opt->checkIndex) && ((O7C_GUARD(Ast_SelArray_s, &(*sel))->index->value_ == NULL) || (O7C_GUARD(Ast_RArray, &(*type))->count == NULL) && (o7c_cmp(O7C_GUARD(Ast_RExprInteger, &O7C_GUARD(Ast_SelArray_s, &(*sel))->index->value_)->int_, 0) !=  0))) {
				TextGenerator_Str(&(*gen)._, gen_tag, "][o7c_ind(", 11);
				ArrayDeclLen(&(*gen), gen_tag, (*type), decl, (*sel));
				TextGenerator_Str(&(*gen)._, gen_tag, ", ", 3);
				expression(&(*gen), gen_tag, O7C_GUARD(Ast_SelArray_s, &(*sel))->index);
				TextGenerator_Str(&(*gen)._, gen_tag, ")", 2);
	...
	if (o7c_cmp(i, 0) <  0) {
		...
		if (o7c_is(sel, Ast_SelRecord_s_tag)) {
			...
			if (o7c_cmp(O7C_GUARD(Ast_SelGuard_s, &sel)->type->_._.id, Ast_IdPointer_cnst) ==  0) {
				TextGenerator_Str(&(*gen)._, gen_tag, "O7C_GUARD(", 11);
				...
				TextGenerator_Str(&(*gen)._, gen_tag, "O7C_GUARD_R(", 13);
			...
			if (o7c_cmp(O7C_GUARD(Ast_SelGuard_s, &sel)->type->_._.id, Ast_IdPointer_cnst) ==  0) {
				...
				TextGenerator_Str(&(*gen)._, gen_tag, "_tag)", 6);
			}
...
static void CheckExpr(struct GeneratorC_Generator *gen, o7c_tag_t gen_tag, struct Ast_RExpression *e) {
	if ((o7c_cmp((*gen).opt->varInit, GeneratorC_VarInitUndefined_cnst) ==  0) && (o7c_is(e, Ast_Designator_s_tag)) && (o7c_cmp(e->type->_._.id, Ast_IdBoolean_cnst) ==  0) && (e->value_ == NULL)) {
		TextGenerator_Str(&(*gen)._, gen_tag, "o7c_bl(", 8);
...
static void Predefined_Call_Expression_Shift(struct GeneratorC_Generator *gen, o7c_tag_t gen_tag, o7c_char shift[/*len0*/], int shift_len0, Ast_Parameter ps) {
	TextGenerator_Str(&(*gen)._, gen_tag, "(int)((unsigned)", 17);
...
static void Predefined_Call_Expression_Len(struct GeneratorC_Generator *gen, o7c_tag_t gen_tag, struct Ast_Designator_s *des) {
	...
	if ((o7c_cmp(des->decl->type->_._.id, Ast_IdArray_cnst) !=  0) || !(o7c_is(des->decl, Ast_FormalParam_s_tag))) {
		TextGenerator_Str(&(*gen)._, gen_tag, "sizeof(", 8);
		Designator(&(*gen), gen_tag, des);
		TextGenerator_Str(&(*gen)._, gen_tag, ") / sizeof (", 13);
		Designator(&(*gen), gen_tag, des);
		TextGenerator_Str(&(*gen)._, gen_tag, "[0])", 5);
...
static void Predefined_Call_Expression_New(struct GeneratorC_Generator *gen, o7c_tag_t gen_tag, struct Ast_RExpression *e) {
	...
	TextGenerator_Str(&(*gen)._, gen_tag, "O7C_NEW(&", 10);
	Expression(&(*gen), gen_tag, e);
	TextGenerator_Str(&(*gen)._, gen_tag, ", ", 3);
...
static void Predefined_Call_Expression_Ord(struct GeneratorC_Generator *gen, o7c_tag_t gen_tag, struct Ast_RExpression *e) {
	TextGenerator_Str(&(*gen)._, gen_tag, "(int)", 6);
...
static void Predefined_Call_Expression_Inc(struct GeneratorC_Generator *gen, o7c_tag_t gen_tag, struct Ast_RExpression *e1, Ast_Parameter p2) {
	...
	if ((*gen).opt->checkArith) {
		TextGenerator_Str(&(*gen)._, gen_tag, " = o7c_add(", 12);
		Expression(&(*gen), gen_tag, e1);
		if (p2 == NULL) {
			TextGenerator_Str(&(*gen)._, gen_tag, ", 1)", 5);
		} else {
			TextGenerator_Str(&(*gen)._, gen_tag, ", ", 3);
...
static void Predefined_Call_Expression_Dec(struct GeneratorC_Generator *gen, o7c_tag_t gen_tag, struct Ast_RExpression *e1, Ast_Parameter p2) {
	Expression(&(*gen), gen_tag, e1);
	if ((*gen).opt->checkArith) {
		TextGenerator_Str(&(*gen)._, gen_tag, " = o7c_sub(", 12);
		Expression(&(*gen), gen_tag, e1);
		if (p2 == NULL) {
			TextGenerator_Str(&(*gen)._, gen_tag, ", 1)", 5);
		} else {
...
static void Call_Expression_Predefined(struct GeneratorC_Generator *gen, o7c_tag_t gen_tag, Ast_ExprCall call) {
	...
	case 90:
		if (o7c_cmp(call->_._.type->_._.id, Ast_IdInteger_cnst) ==  0) {
			TextGenerator_Str(&(*gen)._, gen_tag, "abs(", 5);
		} else {
			TextGenerator_Str(&(*gen)._, gen_tag, "fabs(", 6);
		}
		Expression(&(*gen), gen_tag, e1);
		TextGenerator_Str(&(*gen)._, gen_tag, ")", 2);
		break;
	case 107:
		...
		TextGenerator_Str(&(*gen)._, gen_tag, " % 2 == 1)", 11);
		break;
	case 104:
	...
	case 91:
		...
		break;
	case 111:
		TextGenerator_Str(&(*gen)._, gen_tag, "o7_ror(", 8);
		Expression(&(*gen), gen_tag, e1);
		TextGenerator_Str(&(*gen)._, gen_tag, ", ", 3);
		Expression(&(*gen), gen_tag, p2->expr);
		TextGenerator_Str(&(*gen)._, gen_tag, ")", 2);
	...
	case 99:
		...
		break;
	case 100:
		TextGenerator_Str(&(*gen)._, gen_tag, "(double)", 9);
		Factor(&(*gen), gen_tag, e1);
		break;
	case 108:
	...
	case 96:
		if (o7c_bl((*gen).opt->checkArith) && (e1->value_ == NULL)) {
			TextGenerator_Str(&(*gen)._, gen_tag, "o7c_chr(", 9);
			Factor(&(*gen), gen_tag, e1);
			TextGenerator_Str(&(*gen)._, gen_tag, ")", 2);
		} else {
			TextGenerator_Str(&(*gen)._, gen_tag, "(char unsigned)", 16);
			Factor(&(*gen), gen_tag, e1);
		}
		break;
	case 101:
	...
	case 102:
		Expression(&(*gen), gen_tag, e1);
		TextGenerator_Str(&(*gen)._, gen_tag, " |= 1u << ", 11);
		Factor(&(*gen), gen_tag, p2->expr);
		break;
	case 98:
		Expression(&(*gen), gen_tag, e1);
		TextGenerator_Str(&(*gen)._, gen_tag, " &= ~(1u << ", 13);
		Factor(&(*gen), gen_tag, p2->expr);
		TextGenerator_Str(&(*gen)._, gen_tag, ")", 2);
		break;
	case 106:
	...
	case 109:
		Expression(&(*gen), gen_tag, e1);
		TextGenerator_Str(&(*gen)._, gen_tag, " *= 1 << ", 10);
		Expression(&(*gen), gen_tag, p2->expr);
		break;
	case 113:
		Expression(&(*gen), gen_tag, e1);
...
static void Call_Expression_ActualParam(struct GeneratorC_Generator *gen, o7c_tag_t gen_tag, Ast_Parameter *p, struct Ast_RDeclaration **fp) {
	...
	if ((o7c_cmp(t->_._.id, Ast_IdByte_cnst) ==  0) && (o7c_cmp((*p)->expr->type->_._.id, Ast_IdInteger_cnst) ==  0) && o7c_bl((*gen).opt->checkArith) && ((*p)->expr->value_ == NULL)) {
		TextGenerator_Str(&(*gen)._, gen_tag, "o7c_byte(", 10);
		...
		if ((o7c_cmp(dist, 0) >  0) && !(*gen).opt->plan9) {
			if (o7c_cmp(t->_._.id, Ast_IdPointer_cnst) ==  0) {
				dist = o7c_sub(dist, 1);
				TextGenerator_Str(&(*gen)._, gen_tag, "->_", 4);
			}
		...
		if (o7c_cmp(t->_._.id, Ast_IdRecord_cnst) ==  0) {
			if ((*gen).opt->lastSelectorDereference) {
				TextGenerator_Str(&(*gen)._, gen_tag, ", NULL", 7);
			} else {
				TextGenerator_Str(&(*gen)._, gen_tag, ", ", 3);
				...
				TextGenerator_Str(&(*gen)._, gen_tag, "_tag", 5);
			}
				...
				if (O7C_GUARD(Ast_RArray, &t)->count != NULL) {
					...
					if (o7c_cmp(i,  - 1) ==  0) {
						...
						if (!(o7c_is(O7C_GUARD(Ast_Designator_s, &(*p)->expr)->decl, Ast_FormalParam_s_tag))) {
							for (j = 0; j < i; ++j) {
								TextGenerator_Str(&(*gen)._, gen_tag, "[0]", 4);
							}
						}
					}
					TextGenerator_Str(&(*gen)._, gen_tag, ", ", 3);
...
static void Relation_Expression_Simple(struct GeneratorC_Generator *gen, o7c_tag_t gen_tag, Ast_ExprRelation rel, o7c_char str[/*len0*/], int str_len0) {
	if ((o7c_cmp(rel->exprs[0]->type->_._.id, Ast_IdArray_cnst) ==  0) && ((rel->exprs[0]->value_ == NULL) || !O7C_GUARD(Ast_ExprString_s, &rel->exprs[0]->value_)->asChar)) {
		TextGenerator_Str(&(*gen)._, gen_tag, "o7c_strcmp(", 12);
		...
		TextGenerator_Str(&(*gen)._, gen_tag, "0", 2);
		...
		/* TODO */
		TextGenerator_Str(&(*gen)._, gen_tag, "o7c_cmp(", 9);
		Simple_Relation_Expression_Expr(&(*gen), gen_tag, rel->exprs[0], o7c_sub(0, rel->distance));
		TextGenerator_Str(&(*gen)._, gen_tag, ", ", 3);
		Simple_Relation_Expression_Expr(&(*gen), gen_tag, rel->exprs[1], rel->distance);
		TextGenerator_Str(&(*gen)._, gen_tag, ")", 2);
		TextGenerator_Str(&(*gen)._, gen_tag, str, str_len0);
		TextGenerator_Str(&(*gen)._, gen_tag, " 0", 3);
	} else {
		Simple_Relation_Expression_Expr(&(*gen), gen_tag, rel->exprs[0], o7c_sub(0, rel->distance));
		TextGenerator_Str(&(*gen)._, gen_tag, str, str_len0);
		Simple_Relation_Expression_Expr(&(*gen), gen_tag, rel->exprs[1], rel->distance);
...
static void Relation_Expression_In(struct GeneratorC_Generator *gen, o7c_tag_t gen_tag, Ast_ExprRelation rel) {
	if ((rel->exprs[0]->value_ != NULL) && (o7c_in(O7C_GUARD(Ast_RExprInteger, &rel->exprs[0]->value_)->int_, O7C_SET(0, Limits_SetMax_cnst)))) {
		TextGenerator_Str(&(*gen)._, gen_tag, "!!(", 4);
		TextGenerator_Str(&(*gen)._, gen_tag, " (1u << ", 9);
		...
		if (rel->_.value_ != NULL) {
			TextGenerator_Str(&(*gen)._, gen_tag, "O7C_IN(", 8);
		} else {
			TextGenerator_Str(&(*gen)._, gen_tag, "o7c_in(", 8);
		}
...
static void Expression_SumCheck(struct GeneratorC_Generator *gen, o7c_tag_t gen_tag, Ast_ExprSum sum) {
	...
	if (o7c_cmp(arr[0]->_.type->_._.id, Ast_IdInteger_cnst) ==  0) {
		while (o7c_cmp(i, 0) >  0) {
			...
			case 11:
				TextGenerator_Str(&(*gen)._, gen_tag, "o7c_sub(", 9);
				break;
			case 10:
				TextGenerator_Str(&(*gen)._, gen_tag, "o7c_add(", 9);
				break;
			default:
				abort();
				break;
		...
		while (o7c_cmp(i, 0) >  0) {
			switch (arr[o7c_ind(TranslatorLimits_MaxTermsInSum_cnst, i)]->add) {
			case 11:
				TextGenerator_Str(&(*gen)._, gen_tag, "o7c_fsub(", 10);
				break;
			case 10:
				TextGenerator_Str(&(*gen)._, gen_tag, "o7c_fadd(", 10);
				break;
			default:
				abort();
				break;
	...
	if (o7c_cmp(arr[0]->add, Scanner_Minus_cnst) ==  0) {
		if (o7c_cmp(arr[0]->_.type->_._.id, Ast_IdInteger_cnst) ==  0) {
			TextGenerator_Str(&(*gen)._, gen_tag, "o7c_sub(0, ", 12);
		} else {
			TextGenerator_Str(&(*gen)._, gen_tag, "o7c_fsub(0, ", 13);
		}
...
static void Expression_TermCheck(struct GeneratorC_Generator *gen, o7c_tag_t gen_tag, struct Ast_ExprTerm_s *term) {
	...
	if (o7c_cmp(term->_.type->_._.id, Ast_IdInteger_cnst) ==  0) {
		while (o7c_cmp(i, 0) >=  0) {
			...
			case 150:
				TextGenerator_Str(&(*gen)._, gen_tag, "o7c_mul(", 9);
				break;
			case 153:
				TextGenerator_Str(&(*gen)._, gen_tag, "o7c_div(", 9);
				break;
			case 154:
				TextGenerator_Str(&(*gen)._, gen_tag, "o7c_mod(", 9);
				break;
			default:
				abort();
				break;
		...
		while (o7c_cmp(i, 0) >=  0) {
			switch (arr[o7c_ind(TranslatorLimits_MaxFactorsInTerm_cnst, i)]->mult) {
			case 150:
				TextGenerator_Str(&(*gen)._, gen_tag, "o7c_fmul(", 10);
				break;
			case 151:
				TextGenerator_Str(&(*gen)._, gen_tag, "o7c_fdiv(", 10);
				break;
			default:
				abort();
				break;
...
static void Expression_Boolean(struct GeneratorC_Generator *gen, o7c_tag_t gen_tag, Ast_ExprBoolean e) {
	if (o7c_cmp((*gen).opt->std, GeneratorC_IsoC90_cnst) ==  0) {
		if (e->bool_) {
			TextGenerator_Str(&(*gen)._, gen_tag, "(0 < 1)", 8);
		} else {
			TextGenerator_Str(&(*gen)._, gen_tag, "(0 > 1)", 8);
		}
	} else {
		if (e->bool_) {
			TextGenerator_Str(&(*gen)._, gen_tag, "true", 5);
		} else {
			TextGenerator_Str(&(*gen)._, gen_tag, "false", 6);
		}
	}
}
...
static void Expression_CString(struct GeneratorC_Generator *gen, o7c_tag_t gen_tag, struct Ast_ExprString_s *e) {
	...
	if (e->asChar) {
		ch = o7c_chr(e->_.int_);
		if (ch == (char unsigned)'\'') {
			TextGenerator_Str(&(*gen)._, gen_tag, "(char unsigned)'\\''", 20);
			...
			TextGenerator_Str(&(*gen)._, gen_tag, "0x", 3);
...
static void Expression_IsExtension(struct GeneratorC_Generator *gen, o7c_tag_t gen_tag, Ast_ExprIsExtension is) {
	...
	if (o7c_cmp(is->designator->_._.type->_._.id, Ast_IdPointer_cnst) ==  0) {
		...
		assert(o7c_bl(ret));
		TextGenerator_Str(&(*gen)._, gen_tag, "o7c_is(", 8);
		Expression(&(*gen), gen_tag, &is->designator->_._);
		TextGenerator_Str(&(*gen)._, gen_tag, ", ", 3);
	} else {
		TextGenerator_Str(&(*gen)._, gen_tag, "o7c_is_r(", 10);
		GlobalName(&(*gen), gen_tag, decl);
		TextGenerator_Str(&(*gen)._, gen_tag, "_tag, ", 7);
		GlobalName(&(*gen), gen_tag, decl);
		TextGenerator_Str(&(*gen)._, gen_tag, ", ", 3);
	}
...
static void Expression(struct GeneratorC_Generator *gen, o7c_tag_t gen_tag, struct Ast_RExpression *expr) {
	...
	case 26:
		...
		break;
	case 6:
		TextGenerator_Str(&(*gen)._, gen_tag, "NULL", 5);
		break;
	case 27:
...
static void ProcHead_Parameters(struct GeneratorC_Generator *gen, o7c_tag_t gen_tag, struct Ast_ProcType_s *proc) {
	...
	if (proc->params == NULL) {
		TextGenerator_Str(&(*gen)._, gen_tag, "(void)", 7);
	} else {
		TextGenerator_Str(&(*gen)._, gen_tag, "(", 2);
		p = (&(proc->params)->_._);
...
static void Declarator(struct GeneratorC_Generator *gen, o7c_tag_t gen_tag, struct Ast_RDeclaration *decl, o7c_bool typeDecl, o7c_bool sameType, o7c_bool global) {
	...
	if ((o7c_is(decl, Ast_FormalParam_s_tag)) && ((o7c_bl(O7C_GUARD(Ast_FormalParam_s, &decl)->isVar) && !(o7c_is(decl->type, Ast_RArray_tag))) || (o7c_is(decl->type, Ast_Record_s_tag)))) {
		TextGenerator_Str(&g._, GeneratorC_Generator_tag, "*", 2);
	} else if (o7c_is(decl, Ast_Const_s_tag)) {
		TextGenerator_Str(&g._, GeneratorC_Generator_tag, "const ", 7);
	}
	if (global) {
...
static void Type_Record(struct GeneratorC_Generator *gen, o7c_tag_t gen_tag, struct Ast_Record_s *rec) {
	...
	TextGenerator_Str(&(*gen)._, gen_tag, "struct ", 8);
	if (CheckStructName(&(*gen), gen_tag, rec)) {
		GlobalName(&(*gen), gen_tag, &rec->_._._);
	}
	v = (&(rec->vars)->_);
	if ((v == NULL) && (rec->base == NULL) && !(*gen).opt->gnu) {
		TextGenerator_Str(&(*gen)._, gen_tag, " { int nothing; } ", 19);
	} else {
		TextGenerator_StrOpen(&(*gen)._, gen_tag, " {", 3);
		if (rec->base != NULL) {
			GlobalName(&(*gen), gen_tag, &rec->base->_._._);
			if ((*gen).opt->plan9) {
				TextGenerator_StrLn(&(*gen)._, gen_tag, ";", 2);
			} else {
				TextGenerator_StrLn(&(*gen)._, gen_tag, " _;", 4);
			}
		}
		while (v != NULL) {
		...
		TextGenerator_StrClose(&(*gen)._, gen_tag, "} ", 3);
	}
	MemWriteInvert(&(*O7C_GUARD(MemoryOut, &(*gen)._.out)), NULL);
}
...
static void Type_Array(struct GeneratorC_Generator *gen, o7c_tag_t gen_tag, struct Ast_RArray *arr, o7c_bool sameType) {
	...
	MemWriteInvert(&(*O7C_GUARD(MemoryOut, &(*gen)._.out)), NULL);
	if (arr->count == NULL) {
		TextGenerator_Str(&(*gen)._, gen_tag, "[/*len0", 8);
		i = 0;
		while (o7c_cmp(t->_._.id, Ast_IdArray_cnst) ==  0) {
			i = o7c_add(i, 1);
			TextGenerator_Str(&(*gen)._, gen_tag, ", len", 6);
			TextGenerator_Int(&(*gen)._, gen_tag, i);
			t = t->_.type;
		}
		TextGenerator_Str(&(*gen)._, gen_tag, "*/]", 4);
...
static void Type(struct GeneratorC_Generator *gen, o7c_tag_t gen_tag, struct Ast_RType *type, o7c_bool typeDecl, o7c_bool sameType) {
	if (type == NULL) {
		TextGenerator_Str(&(*gen)._, gen_tag, "void ", 6);
		MemWriteInvert(&(*O7C_GUARD(MemoryOut, &(*gen)._.out)), NULL);
	} else {
...
static void RecordTag(struct GeneratorC_Generator *gen, o7c_tag_t gen_tag, struct Ast_Record_s *rec) {
	if (!rec->_._._.mark || o7c_bl((*gen).opt->main_)) {
		TextGenerator_Str(&(*gen)._, gen_tag, "static o7c_tag_t ", 18);
	} else if ((*gen).interface_) {
		TextGenerator_Str(&(*gen)._, gen_tag, "extern o7c_tag_t ", 18);
	} else {
		TextGenerator_Str(&(*gen)._, gen_tag, "o7c_tag_t ", 11);
	}
	GlobalName(&(*gen), gen_tag, &rec->_._._);
	TextGenerator_StrLn(&(*gen)._, gen_tag, "_tag;", 6);
...
static void TypeDecl_Typedef(struct GeneratorC_Generator *gen, o7c_tag_t gen_tag, struct Ast_RType *type) {
	TextGenerator_Str(&(*gen)._, gen_tag, "typedef ", 9);
...
static void Mark(struct GeneratorC_Generator *gen, o7c_tag_t gen_tag, o7c_bool mark) {
	if (o7c_cmp((*gen).localDeep, 0) ==  0) {
		if (o7c_bl(mark) && !(*gen).opt->main_) {
			TextGenerator_Str(&(*gen)._, gen_tag, "extern ", 8);
		} else {
			TextGenerator_Str(&(*gen)._, gen_tag, "static ", 8);
		}
	}
}
...
static void Const(struct GeneratorC_Generator *gen, o7c_tag_t gen_tag, struct Ast_Const_s *const_) {
	...
	TextGenerator_StrIgnoreIndent(&(*gen)._, gen_tag, "#", 2);
	TextGenerator_Str(&(*gen)._, gen_tag, "define ", 8);
...
static void Var_InitZero(struct GeneratorC_Generator *gen, o7c_tag_t gen_tag, struct Ast_RDeclaration *var_) {
	...
	case 5:
		...
		break;
	case 1:
		TextGenerator_Str(&(*gen)._, gen_tag, " = 0 > 1", 9);
		break;
	case 3:
		TextGenerator_Str(&(*gen)._, gen_tag, " = '\\0'", 8);
		break;
	case 6:
	case 10:
		TextGenerator_Str(&(*gen)._, gen_tag, " = NULL", 8);
		break;
	case 7:
		TextGenerator_Str(&(*gen)._, gen_tag, " ", 2);
		break;
...
static void Var_InitUndef(struct GeneratorC_Generator *gen, o7c_tag_t gen_tag, struct Ast_RDeclaration *var_) {
	switch (var_->type->_._.id) {
	case 0:
		TextGenerator_Str(&(*gen)._, gen_tag, " = O7C_INT_UNDEF", 17);
		break;
	case 1:
		TextGenerator_Str(&(*gen)._, gen_tag, " = O7C_BOOL_UNDEF", 18);
		break;
	case 2:
		TextGenerator_Str(&(*gen)._, gen_tag, " = 0", 5);
		break;
	case 3:
		...
		break;
	case 4:
		TextGenerator_Str(&(*gen)._, gen_tag, " = O7C_DBL_UNDEF", 17);
		break;
	case 5:
		TextGenerator_Str(&(*gen)._, gen_tag, " = 0", 5);
		break;
...
static void Var(struct MOut *out, o7c_tag_t out_tag, struct Ast_RDeclaration *prev, struct Ast_RDeclaration *var_, o7c_bool last) {
	...
	if (!same) {
		if (prev != NULL) {
			TextGenerator_StrLn(&(*out).g[o7c_ind(2, (int)mark)]._, GeneratorC_Generator_tag, ";", 2);
		}
		Mark(&(*out).g[o7c_ind(2, (int)mark)], GeneratorC_Generator_tag, mark);
	} else {
		TextGenerator_Str(&(*out).g[o7c_ind(2, (int)mark)]._, GeneratorC_Generator_tag, ", ", 3);
	}
	if (mark) {
		Declarator(&(*out).g[Interface_cnst], GeneratorC_Generator_tag, var_, false, same, true);
		if (last) {
			TextGenerator_StrLn(&(*out).g[Interface_cnst]._, GeneratorC_Generator_tag, ";", 2);
		}
		if (same) {
			TextGenerator_Str(&(*out).g[Implementation_cnst]._, GeneratorC_Generator_tag, ", ", 3);
		} else if (prev != NULL) {
			TextGenerator_StrLn(&(*out).g[Implementation_cnst]._, GeneratorC_Generator_tag, ";", 2);
		}
	}
	...
	case 2:
		if ((o7c_cmp(var_->type->_._.id, Ast_IdPointer_cnst) ==  0) && (o7c_cmp((*out).opt->memManager, GeneratorC_MemManagerCounter_cnst) ==  0)) {
			TextGenerator_Str(&(*out).g[Implementation_cnst]._, GeneratorC_Generator_tag, " = NULL", 8);
		}
		break;
	default:
		abort();
...
static void ExprThenStats(struct GeneratorC_Generator *gen, o7c_tag_t gen_tag, struct Ast_RWhileIf **wi) {
	...
	TextGenerator_StrOpen(&(*gen)._, gen_tag, ") {", 4);
...
static void WhileIf_Statement_Elsif(struct GeneratorC_Generator *gen, o7c_tag_t gen_tag, struct Ast_RWhileIf **wi) {
	while (((*wi) != NULL) && ((*wi)->_.expr != NULL)) {
		TextGenerator_StrClose(&(*gen)._, gen_tag, "} else if (", 12);
...
static void Statement_WhileIf(struct GeneratorC_Generator *gen, o7c_tag_t gen_tag, struct Ast_RWhileIf *wi) {
	if (o7c_is(wi, Ast_If_s_tag)) {
		TextGenerator_Str(&(*gen)._, gen_tag, "if (", 5);
		ExprThenStats(&(*gen), gen_tag, &wi);
		WhileIf_Statement_Elsif(&(*gen), gen_tag, &wi);
		if (wi != NULL) {
			TextGenerator_IndentClose(&(*gen)._, gen_tag);
			TextGenerator_StrOpen(&(*gen)._, gen_tag, "} else {", 9);
			statements(&(*gen), gen_tag, wi->stats);
		}
		TextGenerator_StrLnClose(&(*gen)._, gen_tag, "}", 2);
	} else if (wi->elsif == NULL) {
		TextGenerator_Str(&(*gen)._, gen_tag, "while (", 8);
		ExprThenStats(&(*gen), gen_tag, &wi);
		TextGenerator_StrLnClose(&(*gen)._, gen_tag, "}", 2);
	} else {
		TextGenerator_Str(&(*gen)._, gen_tag, "while (1) if (", 15);
		ExprThenStats(&(*gen), gen_tag, &wi);
		WhileIf_Statement_Elsif(&(*gen), gen_tag, &wi);
		TextGenerator_StrLnClose(&(*gen)._, gen_tag, "} else break;", 14);
	}
}

static void Statement_Repeat(struct GeneratorC_Generator *gen, o7c_tag_t gen_tag, Ast_Repeat st) {
	TextGenerator_StrOpen(&(*gen)._, gen_tag, "do {", 5);
	statements(&(*gen), gen_tag, st->stats);
	if (o7c_cmp(st->_.expr->_.id, Ast_IdNegate_cnst) ==  0) {
		TextGenerator_StrClose(&(*gen)._, gen_tag, "} while (", 10);
		Expression(&(*gen), gen_tag, O7C_GUARD(Ast_ExprNegate_s, &st->_.expr)->expr);
		TextGenerator_StrLn(&(*gen)._, gen_tag, ");", 3);
	} else {
		TextGenerator_StrClose(&(*gen)._, gen_tag, "} while (!(", 12);
		Expression(&(*gen), gen_tag, st->_.expr);
		TextGenerator_StrLn(&(*gen)._, gen_tag, "));", 4);
	}
}
...
static void Statement_For(struct GeneratorC_Generator *gen, o7c_tag_t gen_tag, Ast_For st) {
	TextGenerator_Str(&(*gen)._, gen_tag, "for (", 6);
...
static void Statement_Assign(struct GeneratorC_Generator *gen, o7c_tag_t gen_tag, Ast_Assign st) {
	...
	if (o7c_bl(retain) && (o7c_cmp(st->_.expr->_.id, Ast_IdPointer_cnst) ==  0)) {
		TextGenerator_Str(&(*gen)._, gen_tag, "O7C_NULL(&", 11);
		Designator(&(*gen), gen_tag, st->designator);
		reref = false;
	} else {
		if (retain) {
			TextGenerator_Str(&(*gen)._, gen_tag, "O7C_ASSIGN(&", 13);
			Designator(&(*gen), gen_tag, st->designator);
			TextGenerator_Str(&(*gen)._, gen_tag, ", ", 3);
			...
			TextGenerator_Str(&(*gen)._, gen_tag, "memcpy(", 8);
			Designator(&(*gen), gen_tag, st->designator);
			TextGenerator_Str(&(*gen)._, gen_tag, ", ", 3);
		} else if (toByte) {
			Designator(&(*gen), gen_tag, st->designator);
			TextGenerator_Str(&(*gen)._, gen_tag, " = o7c_byte(", 13);
		} else {
			Designator(&(*gen), gen_tag, st->designator);
			TextGenerator_Str(&(*gen)._, gen_tag, " = ", 4);
		}
		...
		if (!reref) {
			...
			if (o7c_cmp(st->_.expr->type->_._.id, Ast_IdRecord_cnst) ==  0) {
				...
				/*  & (st.designator.type.type.id # Ast.IdString) */
				if (O7C_GUARD(Ast_RArray, &st->_.expr->type)->count != NULL) {
					TextGenerator_Str(&(*gen)._, gen_tag, ", sizeof(", 10);
					Expression(&(*gen), gen_tag, st->_.expr);
					TextGenerator_Str(&(*gen)._, gen_tag, ")", 2);
				} else {
					TextGenerator_Str(&(*gen)._, gen_tag, ", (", 4);
					ArrayLen(&(*gen), gen_tag, st->_.expr);
					TextGenerator_Str(&(*gen)._, gen_tag, ") * sizeof(", 12);
					Expression(&(*gen), gen_tag, st->_.expr);
					TextGenerator_Str(&(*gen)._, gen_tag, "[0])", 5);
				}
			}
			...
			TextGenerator_Str(&(*gen)._, gen_tag, "(&(", 4);
			Expression(&(*gen), gen_tag, st->_.expr);
			TextGenerator_Str(&(*gen)._, gen_tag, ")->_", 5);
		}
...
static void Case_Statement_CaseElement(struct GeneratorC_Generator *gen, o7c_tag_t gen_tag, Ast_CaseElement elem) {
	...
	if (!IsCaseElementWithRange(elem)) {
		r = elem->labels;
		while (r != NULL) {
			TextGenerator_Str(&(*gen)._, gen_tag, "case ", 6);
		...
		TextGenerator_StrLn(&(*gen)._, gen_tag, "break;", 7);
		TextGenerator_IndentClose(&(*gen)._, gen_tag);
	}
}
...
static void CaseElementAsIf_Case_Statement_CaseRange(struct GeneratorC_Generator *gen, o7c_tag_t gen_tag, Ast_CaseLabel r, struct Ast_RExpression *caseExpr) {
	if (r->right == NULL) {
		if (caseExpr == NULL) {
			TextGenerator_Str(&(*gen)._, gen_tag, "(o7c_case_expr == ", 19);
		} else {
			TextGenerator_Str(&(*gen)._, gen_tag, "(", 2);
		...
		TextGenerator_Int(&(*gen)._, gen_tag, r->value_);
		if (caseExpr == NULL) {
			TextGenerator_Str(&(*gen)._, gen_tag, " <= o7c_case_expr && o7c_case_expr <= ", 39);
		} else {
			TextGenerator_Str(&(*gen)._, gen_tag, " <= ", 5);
			Expression(&(*gen), gen_tag, caseExpr);
			TextGenerator_Str(&(*gen)._, gen_tag, " && ", 5);
...
static void Case_Statement_CaseElementAsIf(struct GeneratorC_Generator *gen, o7c_tag_t gen_tag, Ast_CaseElement elem, struct Ast_RExpression *caseExpr) {
	...
	TextGenerator_StrOpen(&(*gen)._, gen_tag, ") {", 4);
	statements(&(*gen), gen_tag, elem->stats);
	TextGenerator_StrClose(&(*gen)._, gen_tag, "}", 2);
}
...
static void Statement_Case(struct GeneratorC_Generator *gen, o7c_tag_t gen_tag, Ast_Case st) {
	...
	if ((elemWithRange == NULL) && !((o7c_is(st->_.expr, Ast_RFactor_tag)) && !(o7c_is(st->_.expr, Ast_ExprBraces_s_tag)))) {
		caseExpr = NULL;
		TextGenerator_Str(&(*gen)._, gen_tag, "{ int o7c_case_expr = ", 23);
		Expression(&(*gen), gen_tag, st->_.expr);
		TextGenerator_StrOpen(&(*gen)._, gen_tag, ";", 2);
		TextGenerator_StrLn(&(*gen)._, gen_tag, "switch (o7c_case_expr) {", 25);
	} else {
		caseExpr = st->_.expr;
		TextGenerator_Str(&(*gen)._, gen_tag, "switch (", 9);
		Expression(&(*gen), gen_tag, caseExpr);
		TextGenerator_StrLn(&(*gen)._, gen_tag, ") {", 4);
	}
	elem = st->elements;
	...
	TextGenerator_StrOpen(&(*gen)._, gen_tag, "default:", 9);
	if (elemWithRange != NULL) {
		...
		while (elem != NULL) {
			if (IsCaseElementWithRange(elem)) {
				TextGenerator_Str(&(*gen)._, gen_tag, " else ", 7);
				Case_Statement_CaseElementAsIf(&(*gen), gen_tag, elem, caseExpr);
			}
			elem = elem->next;
		}
		if ((*gen).opt->caseAbort) {
			TextGenerator_StrLn(&(*gen)._, gen_tag, " else abort();", 15);
		}
	} else if ((*gen).opt->caseAbort) {
		TextGenerator_StrLn(&(*gen)._, gen_tag, "abort();", 9);
	}
	TextGenerator_StrLn(&(*gen)._, gen_tag, "break;", 7);
	TextGenerator_StrLnClose(&(*gen)._, gen_tag, "}", 2);
	if (caseExpr == NULL) {
...
static void Qualifier(struct GeneratorC_Generator *gen, o7c_tag_t gen_tag, struct Ast_RType *type) {
	switch (type->_._.id) {
	case 0:
		TextGenerator_Str(&(*gen)._, gen_tag, "int", 4);
		break;
	case 5:
		TextGenerator_Str(&(*gen)._, gen_tag, "unsigned", 9);
		break;
	case 1:
		if ((o7c_cmp((*gen).opt->std, GeneratorC_IsoC99_cnst) >=  0) && (o7c_cmp((*gen).opt->varInit, GeneratorC_VarInitUndefined_cnst) !=  0)) {
			TextGenerator_Str(&(*gen)._, gen_tag, "bool", 5);
		} else {
			TextGenerator_Str(&(*gen)._, gen_tag, "o7c_bool", 9);
		}
		break;
	case 2:
		TextGenerator_Str(&(*gen)._, gen_tag, "char unsigned", 14);
		break;
	case 3:
		TextGenerator_Str(&(*gen)._, gen_tag, "o7c_char", 9);
		break;
	case 4:
		TextGenerator_Str(&(*gen)._, gen_tag, "double", 7);
		break;
	case 6:
	case 10:
		GlobalName(&(*gen), gen_tag, &type->_);
...
static void Implement_Procedure_CloseConsts(struct GeneratorC_Generator *gen, o7c_tag_t gen_tag, struct Ast_RDeclaration *consts) {
	while ((consts != NULL) && (o7c_is(consts, Ast_Const_s_tag))) {
		TextGenerator_StrIgnoreIndent(&(*gen)._, gen_tag, "#", 2);
		TextGenerator_Str(&(*gen)._, gen_tag, "undef ", 7);
...
static void Implement_Procedure_RetainParams(struct GeneratorC_Generator *gen, o7c_tag_t gen_tag, struct Ast_RDeclaration *fp) {
	if (fp != NULL) {
		TextGenerator_Str(&(*gen)._, gen_tag, "o7c_retain(", 12);
		Name(&(*gen), gen_tag, fp);
		fp = fp->next;
		while (fp != NULL) {
			if ((o7c_cmp(fp->type->_._.id, Ast_IdPointer_cnst) ==  0) && !O7C_GUARD(Ast_FormalParam_s, &fp)->isVar) {
				TextGenerator_Str(&(*gen)._, gen_tag, "); o7c_retain(", 15);
				Name(&(*gen), gen_tag, fp);
			}
			fp = fp->next;
		}
...
static void Implement_Procedure_ReleaseParams(struct GeneratorC_Generator *gen, o7c_tag_t gen_tag, struct Ast_RDeclaration *fp) {
	if (fp != NULL) {
		TextGenerator_Str(&(*gen)._, gen_tag, "o7c_release(", 13);
		Name(&(*gen), gen_tag, fp);
		fp = fp->next;
		while (fp != NULL) {
			if ((o7c_cmp(fp->type->_._.id, Ast_IdPointer_cnst) ==  0) && !O7C_GUARD(Ast_FormalParam_s, &fp)->isVar) {
				TextGenerator_Str(&(*gen)._, gen_tag, "); o7c_release(", 16);
				Name(&(*gen), gen_tag, fp);
			}
			fp = fp->next;
		}
...
static void Procedure_Implement(struct MOut *out, o7c_tag_t out_tag, struct GeneratorC_Generator *gen, o7c_tag_t gen_tag, struct Ast_RProcedure *proc) {
	...
	if (o7c_cmp((*gen).opt->memManager, GeneratorC_MemManagerCounter_cnst) !=  0) {
		...
		if (proc->_.return_ != NULL) {
			...
			if (o7c_cmp(proc->_.return_->type->_._.id, Ast_IdPointer_cnst) ==  0) {
				TextGenerator_StrLn(&(*gen)._, gen_tag, " o7c_return = NULL;", 20);
			} else {
				TextGenerator_StrLn(&(*gen)._, gen_tag, " o7c_return;", 13);
			}
		}
	}
	...
	if (proc->_.return_ == NULL) {
		...
		if ((o7c_cmp((*gen).opt->memManager, GeneratorC_MemManagerCounter_cnst) ==  0) && (proc->_.return_ != NULL)) {
			if (o7c_cmp(proc->_.return_->type->_._.id, Ast_IdPointer_cnst) ==  0) {
				TextGenerator_Str(&(*gen)._, gen_tag, "O7C_ASSIGN(&o7c_return, ", 25);
				CheckExpr(&(*gen), gen_tag, proc->_.return_);
				TextGenerator_StrLn(&(*gen)._, gen_tag, ");", 3);
			} else {
				TextGenerator_Str(&(*gen)._, gen_tag, "o7c_return = ", 14);
				CheckExpr(&(*gen), gen_tag, proc->_.return_);
				TextGenerator_StrLn(&(*gen)._, gen_tag, ";", 2);
			}
			Implement_Procedure_ReleaseVars(&(*gen), gen_tag, &proc->_._.vars->_);
			Implement_Procedure_ReleaseParams(&(*gen), gen_tag, retainParams);
			if (o7c_cmp(proc->_.return_->type->_._.id, Ast_IdPointer_cnst) ==  0) {
				TextGenerator_StrLn(&(*gen)._, gen_tag, "o7c_unhold(o7c_return);", 24);
			}
			TextGenerator_StrLn(&(*gen)._, gen_tag, "return o7c_return;", 19);
		} else {
			Implement_Procedure_ReleaseVars(&(*gen), gen_tag, &proc->_._.vars->_);
			Implement_Procedure_ReleaseParams(&(*gen), gen_tag, retainParams);
			TextGenerator_Str(&(*gen)._, gen_tag, "return ", 8);
			CheckExpr(&(*gen), gen_tag, proc->_.return_);
			TextGenerator_StrLn(&(*gen)._, gen_tag, ";", 2);
		}
	}
	...
	while ((d != NULL) && (o7c_is(d, Ast_RVar_tag))) {
		if (o7c_in(d->type->_._.id, ((1 << Ast_IdArray_cnst) | (1 << Ast_IdRecord_cnst)))) {
			if ((o7c_cmp((*gen).opt->varInit, GeneratorC_VarInitZero_cnst) ==  0) || (o7c_cmp(d->type->_._.id, Ast_IdRecord_cnst) ==  0) || (o7c_cmp(d->type->_._.id, Ast_IdArray_cnst) ==  0) && !VarsInit_IsConformArrayType(d->type, &arrTypeId, &arrDeep)) {
				TextGenerator_Str(&(*gen)._, gen_tag, "memset(&", 9);
				Name(&(*gen), gen_tag, d);
				TextGenerator_Str(&(*gen)._, gen_tag, ", 0, sizeof(", 13);
				Name(&(*gen), gen_tag, d);
				TextGenerator_StrLn(&(*gen)._, gen_tag, "));", 4);
			} else {
				...
				switch (arrTypeId) {
				case 0:
					TextGenerator_Str(&(*gen)._, gen_tag, "o7c_ints_undef(", 16);
					break;
				case 4:
					TextGenerator_Str(&(*gen)._, gen_tag, "o7c_doubles_undef(", 19);
					break;
				case 1:
					TextGenerator_Str(&(*gen)._, gen_tag, "o7c_bools_undef(", 17);
					break;
				default:
					abort();
					break;
				...
				TextGenerator_StrLn(&(*gen)._, gen_tag, "[0]));", 7);
			}
		}
		d = d->next;
	}
...
static void MarkType(struct Ast_RType *t) {
	...
	while ((t != NULL) && !t->_.mark) {
		...
		if (o7c_cmp(t->_._.id, Ast_IdArray_cnst) ==  0) {
			...
			while (d != NULL) {
				MarkType(d->type);
				if (StringStore_IsDefined(&d->name, StringStore_String_tag)) {
...
static void ImportInit(struct GeneratorC_Generator *gen, o7c_tag_t gen_tag, struct Ast_RDeclaration *imp) {
	if (imp != NULL) {
		...
		do {
			...
			TextGenerator_StrLn(&(*gen)._, gen_tag, "_init();", 9);
			imp = imp->next;
		} while (!((imp == NULL) || !(o7c_is(imp, Ast_Import_s_tag))));
		TextGenerator_Ln(&(*gen)._, gen_tag);
	}
...
static void TagsInit(struct GeneratorC_Generator *gen, o7c_tag_t gen_tag) {
	...
	while ((*gen).opt->records != NULL) {
		...
		r->_._._._.ext = NULL;
		TextGenerator_Str(&(*gen)._, gen_tag, "o7c_tag_init(", 14);
		GlobalName(&(*gen), gen_tag, &r->_._._);
		if (r->base == NULL) {
			TextGenerator_StrLn(&(*gen)._, gen_tag, "_tag, NULL);", 13);
		} else {
			TextGenerator_Str(&(*gen)._, gen_tag, "_tag, ", 7);
			GlobalName(&(*gen), gen_tag, &r->base->_._._);
			TextGenerator_StrLn(&(*gen)._, gen_tag, "_tag);", 7);
		}
	}
	if (r != NULL) {
		TextGenerator_Ln(&(*gen)._, gen_tag);
...
static void Generate_Includes(struct GeneratorC_Generator *gen, o7c_tag_t gen_tag) {
	TextGenerator_StrLn(&(*gen)._, gen_tag, "#include <stdlib.h>", 20);
	TextGenerator_StrLn(&(*gen)._, gen_tag, "#include <stddef.h>", 20);
	TextGenerator_StrLn(&(*gen)._, gen_tag, "#include <string.h>", 20);
	TextGenerator_StrLn(&(*gen)._, gen_tag, "#include <assert.h>", 20);
	TextGenerator_StrLn(&(*gen)._, gen_tag, "#include <math.h>", 18);
	if (o7c_cmp((*gen).opt->std, GeneratorC_IsoC99_cnst) >=  0) {
		TextGenerator_StrLn(&(*gen)._, gen_tag, "#include <stdbool.h>", 21);
	}
	TextGenerator_Ln(&(*gen)._, gen_tag);
	if (o7c_cmp((*gen).opt->varInit, GeneratorC_VarInitUndefined_cnst) ==  0) {
		TextGenerator_StrLn(&(*gen)._, gen_tag, "#define O7C_BOOL_UNDEFINED", 27);
	}
	TextGenerator_StrLn(&(*gen)._, gen_tag, "#include <o7c.h>", 17);
	TextGenerator_Ln(&(*gen)._, gen_tag);
}

static void Generate_HeaderGuard(struct GeneratorC_Generator *gen, o7c_tag_t gen_tag) {
	TextGenerator_Str(&(*gen)._, gen_tag, "#if !defined(HEADER_GUARD_", 27);
	TextGenerator_String(&(*gen)._, gen_tag, &(*gen).module->_._.name, StringStore_String_tag);
	TextGenerator_StrLn(&(*gen)._, gen_tag, ")", 2);
	TextGenerator_Str(&(*gen)._, gen_tag, "#define HEADER_GUARD_", 22);
	TextGenerator_String(&(*gen)._, gen_tag, &(*gen).module->_._.name, StringStore_String_tag);
	TextGenerator_Ln(&(*gen)._, gen_tag);
	TextGenerator_Ln(&(*gen)._, gen_tag);
}
...
static void Generate_ModuleInit(struct GeneratorC_Generator *interf, o7c_tag_t interf_tag, struct GeneratorC_Generator *impl, o7c_tag_t impl_tag, struct Ast_RModule *module) {
	if ((module->import_ == NULL) && (module->_.stats == NULL) && ((*impl).opt->records == NULL)) {
		if (o7c_cmp((*impl).opt->std, GeneratorC_IsoC99_cnst) >=  0) {
			TextGenerator_Str(&(*interf)._, interf_tag, "static inline void ", 20);
		} else {
			TextGenerator_Str(&(*interf)._, interf_tag, "static void ", 13);
		}
		Name(&(*interf), interf_tag, &module->_._);
		TextGenerator_StrLn(&(*interf)._, interf_tag, "_init(void) { ; }", 18);
	} else {
		TextGenerator_Str(&(*interf)._, interf_tag, "extern void ", 13);
		Name(&(*interf), interf_tag, &module->_._);
		TextGenerator_StrLn(&(*interf)._, interf_tag, "_init(void);", 13);
		TextGenerator_Str(&(*impl)._, impl_tag, "extern void ", 13);
		Name(&(*impl), impl_tag, &module->_._);
		TextGenerator_StrOpen(&(*impl)._, impl_tag, "_init(void) {", 14);
		TextGenerator_StrLn(&(*impl)._, impl_tag, "static int initialized = 0;", 28);
		TextGenerator_StrOpen(&(*impl)._, impl_tag, "if (0 == initialized) {", 24);
		ImportInit(&(*impl), impl_tag, &module->import_->_);
		TagsInit(&(*impl), impl_tag);
		Statements(&(*impl), impl_tag, module->_.stats);
		TextGenerator_StrLnClose(&(*impl)._, impl_tag, "}", 2);
		TextGenerator_StrLn(&(*impl)._, impl_tag, "++initialized;", 15);
		TextGenerator_StrLnClose(&(*impl)._, impl_tag, "}", 2);
...
static void Generate_Main(struct GeneratorC_Generator *gen, o7c_tag_t gen_tag, struct Ast_RModule *module) {
	TextGenerator_StrOpen(&(*gen)._, gen_tag, "extern int main(int argc, char **argv) {", 41);
	TextGenerator_StrLn(&(*gen)._, gen_tag, "o7c_init(argc, argv);", 22);
	ImportInit(&(*gen), gen_tag, &module->import_->_);
	TagsInit(&(*gen), gen_tag);
	if (module->_.stats != NULL) {
		Statements(&(*gen), gen_tag, module->_.stats);
	}
	TextGenerator_StrLn(&(*gen)._, gen_tag, "return o7c_exit_code;", 22);
	TextGenerator_StrLnClose(&(*gen)._, gen_tag, "}", 2);
}
...
extern void GeneratorC_Generate(struct VDataStream_Out *interface_, struct VDataStream_Out *implementation, struct Ast_RModule *module, struct GeneratorC_Options_s *opt) {
	...
	if (opt->main_) {
		...
		TextGenerator_StrLn(&out.g[Interface_cnst]._, GeneratorC_Generator_tag, "#endif", 7);
	}
}
