...
S(" 9) ost          Файл.mod         [ Пар-ры ]");
S(" A) ost .Команда Файл.mod         [ Пар-ры ]");
S(" B) ost .        Файл.mod Команда [ Пар-ры ]");
IF full THEN
S("");
...
S("9-B) запускает код модуля в файле, можно использовать совместно с she-bang");
S("");
