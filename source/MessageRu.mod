...
S(" C) ost .Команда Файл.mod         [ Пар-ры ]");
S(" D) ost .        Файл.mod Команда [ Пар-ры ]");
IF full THEN
S("");
...
S("A) to-mod   преобразовывает модули обратно в код 1-го из диалектов Оберона");
S("B-D) запускает код модуля в файле, можно использовать совместно с she-bang");
S("");
